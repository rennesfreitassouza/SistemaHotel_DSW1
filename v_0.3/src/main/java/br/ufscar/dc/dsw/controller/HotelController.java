...
public class HotelController extends HttpServlet {
    ...
    private void lista(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	List<PromoHotel> listaPromoHotel = dao.getPromohotel(usuario.getId(), usuario.getCnpj());
    ...
    private void insere(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    	...
    	List<PromoHotel> listaPromoHotel = dao.getPromohotel(hotel.getId(), hotel.getCnpj());
        ...
        for(int i = 0; i < listaPromoHotel.size(); i++) { //verifica se  outra promocao na mesma data
        	if(listaPromoHotel.get(i).getIniciopromo().equals(iniciopromo)) {
        		isDate = false;
        	}
        }
    	if(isDate) {
    ...
    private void atualize(HttpServletRequest request, HttpServletResponse response)
        ...
        for(int i = 0; i < listaPromoHotel.size(); i++) { //verifica se  outra promocao na mesma data
        	if(listaPromoHotel.get(i).getIniciopromo().equals(iniciopromo)&(listaPromoHotel.get(i).getId() != id)) {
        		isDate = false;
        	}
        }
    	if(isDate) {
